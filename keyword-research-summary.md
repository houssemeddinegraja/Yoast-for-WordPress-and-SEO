# Keyword Research — Simple Summary
...
- **Head keyphrases** – broad, generic terms that reflect a site's main topic(s) (e.g., `SEO` for an SEO blog). Usually only large, authoritative sites can realistically rank for these.
- **Mid-tail keyphrases** – more specific variations tied to a head keyphrase (e.g., `homemade Italian pasta`).
- **Long-tail keyphrases** – very specific, niche phrases (e.g., `homemade Italian spaghetti bolognese`). These are easier to rank for, and can run up to 6–7 words for smaller sites.

## What Is Keyword Research?

Keyword research means figuring out, *before* you write content, which exact search terms your audience uses — so your site matches how they actually search. Skipping this leads to a common problem: a mismatch between the words you use to describe your product and the words your audience uses to search for it.
...
- **Yoast Suggest** – uses Google Suggest to expand a keyphrase into more long-tail options.
...
|---|---|
| Informational | Find information on a topic |
| Navigational | Reach a specific website |
| Commercial | Research before making a purchase |
| Transactional | Actually buy something |
...
- Good keyword research ensures you use the words your actual audience searches for.
- The process has 5 steps: **define your mission → list keyphrases → check search intent → research competitors → build landing pages.**
